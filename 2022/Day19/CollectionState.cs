...
)
{
    ...
    public CollectionState BuildRobot(RobotType robot, IEnumerable<Ingredient> recipe)
    {
        ...
        return robot switch
        {
            RobotType.Ore
                => new(
                    newState.MinutesPassed,
                    newState.OreStore.IncrementProduction(),
                    newState.ClayStore,
                    newState.ObsidianStore,
                    newState.GeodeStore
                ),
            RobotType.Clay
                => new(
                    newState.MinutesPassed,
                    newState.OreStore,
                    newState.ClayStore.IncrementProduction(),
                    newState.ObsidianStore,
                    newState.GeodeStore
                ),
            RobotType.Obsidian
                => new(
                    ...
                    newState.OreStore,
                    newState.ClayStore,
                    newState.ObsidianStore.IncrementProduction(),
                    newState.GeodeStore
                ),
            RobotType.Geode
                => new(
                    ...
                    newState.ClayStore,
                    newState.ObsidianStore,
                    newState.GeodeStore.IncrementProduction()
                ),
    ...
    private CollectionState Consume(Ingredient ingredient)
    {
        return ingredient.ResourceType switch
        {
            ResourceType.Ore
                => new(
                    MinutesPassed,
                    OreStore.Consume(ingredient.RequiredQuantity),
                    ClayStore,
                    ObsidianStore,
                    GeodeStore
                ),
            ResourceType.Clay
                => new(
                    MinutesPassed,
                    OreStore,
                    ClayStore.Consume(ingredient.RequiredQuantity),
                    ObsidianStore,
                    GeodeStore
                ),
            ResourceType.Obsidian
                => new(
                    ...
                    OreStore,
                    ClayStore,
                    ObsidianStore.Consume(ingredient.RequiredQuantity),
                    GeodeStore
                ),
            ResourceType.Geode
                => new(
                    ...
                    ClayStore,
                    ObsidianStore,
                    GeodeStore.Consume(ingredient.RequiredQuantity)
                ),
